...
exports.seed = function(knex) {
  return knex('users').insert([
    {username: 'test', firstname: 'testing', lastname: 'tests', email: 'test@testing.com', password: 'test123', streetAddress: '1548 Test St.', city: 'Dallas', state: 'Texas', zipcode: '74802', role: 'owner'},
